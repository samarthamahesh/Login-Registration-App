            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center my-auto">
                <div class="d-flex flex-column align-items-center col-8 col-sm-6 col-md-6 col-lg-8 col-xl-6 mx-auto my-auto h-100" style={{"--bs-bg-opacity": .1}}>
                    <div class="d-flex justify-content-between col-12">
                        <div>
                            <span class="col-6 h4">Sign in</span>
                        </div>
                        <div class='mt-1'>
                            <span class="col-6">or <Link to='/register'><a href="/" class="text-decoration-none">create an account</a></Link></span>
                        </div>
                    </div>
                    <button type="button" class="btn btn-primary col-12 mt-4"><i class="fa fa-google pull-left"></i> Sign in with Google</button>
                    <button type="button" class="btn btn-dark col-12 mt-4"><i class="fa fa-apple pull-left"></i> Sign in with Apple</button>
                    ...
                    <form class="col-12 mx-auto">
                        ...
                        <div class="d-flex justify-content-between col-12 mt-4">
                            ...
                            <div>
                                <button type="button" class="align-items-end btn btn-primary m-auto px-3" onClick={onLogin}>Sign in</button>
                            </div>
                        </div>
                        <div class='mt-4'>
